...
class JConfig
{
	...
	public $sitename = 'zoom zoom';            // Name of Joomla site
	...
	public $host = 'localhost:30013';              // This is normally set to localhost
	...
	/* Server Settings */
	public $secret = 'B2y3xhO6JIAM9O8Z';     // Change this to something more secure
	public $gzip = '0';
	...
	public $ftp_root = '';
	public $ftp_enable = '0';
	public $tmp_path = 'C:\Users\pc\Documents\Stackabl74\zoom zoom\code/tmp/';                // This path needs to be writable by Joomla!
	public $log_path = 'C:\Users\pc\Documents\Stackabl74\zoom zoom\code/logs/'; // This path needs to be writable by Joomla!
